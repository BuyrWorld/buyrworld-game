...
- [x] **Districts v1** · data-driven district registry (`data/districts.ts`) grouping existing buildings into 7 live + 2 planned districts; Town Directory modal (🗺️ HUD button + map sign) with status/buildings and fast-travel; on-map "you're in" chip + hub banners; Harbour gated at total lvl 100
