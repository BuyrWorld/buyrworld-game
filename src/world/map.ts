...
export const V_OBJECTS: WorldObject[] = [
  ...
  { id: 'rock_iron2',  kind: 'rock',  tx: 7,  ty: 23, ore: 'iron_ore',   lvl: 1,  vein: '#aab2bd' },
  ...
  { id: 'rock_iron4',  kind: 'rock',  tx: 6,  ty: 24, ore: 'iron_ore',   lvl: 1,  vein: '#aab2bd' },
  { id: 'rock_coal',   kind: 'rock',  tx: 2,  ty: 27, ore: 'coal',       lvl: 10, vein: '#2f2f38' },
  { id: 'rock_copper2',kind: 'rock',  tx: 3,  ty: 27, ore: 'copper_ore', lvl: 5,  vein: '#c97b45' },
  { id: 'rock_baux',   kind: 'rock',  tx: 4,  ty: 27, ore: 'bauxite',    lvl: 20, vein: '#e0863a' },
  { id: 'rock_baux2',  kind: 'rock',  tx: 5,  ty: 27, ore: 'bauxite',    lvl: 20, vein: '#e0863a' },
  { id: 'rock_coal2',  kind: 'rock',  tx: 6,  ty: 27, ore: 'coal',       lvl: 10, vein: '#2f2f38' },
  { id: 'rock_rare',   kind: 'rock',  tx: 7,  ty: 27, ore: 'rare_earth', lvl: 40, vein: '#7ee0ff', sparkle: true },
  ...
  { id: 'cottage_bin', kind: 'bin', tx: 76, ty: 27, w: 1, h: 1, name: 'Household Bin', ic: '🗑️' },
